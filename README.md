...
```
    ...
    <matplotlib.axes._subplots.AxesSubplot at 0x7f38500e9cc0>
...
```
    ...
    Progress: 0.1% ... Training loss: 0.969 ... Validation loss: 1.850

    /media/kartik_nighania/data/anaconda3/envs/dlnd/lib/python3.6/site-packages/ipykernel_launcher.py:15: DeprecationWarning: 
    ...
    Progress: 100.0% ... Training loss: 0.060 ... Validation loss: 0.156
...
```
    ...
    /media/kartik_nighania/data/anaconda3/envs/dlnd/lib/python3.6/site-packages/ipykernel_launcher.py:10: DeprecationWarning: 
    .ix is deprecated. Please use
    .loc for label based indexing or
    .iloc for positional indexing
